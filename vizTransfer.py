...
def visualize_layer(model,
    ...
    def _generate_filter_image(input_img,
        ...
        for up in reversed(range(upscaling_steps)):
            ...
            input_img_data = process_image(img, input_img_data[0]).reshape(1, img.shape[0], img.shape[1], img.shape[2])
...
if __name__ == '__main__':
    ...
    new_model, conv_model = nt.create_model(FC_layers,3)
    ...
    visualize_layer(conv_model, LAYER_NAME)
